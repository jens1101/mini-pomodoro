...
export class ComponentHelper {
   ...
   * document is located.
   * @return A promise that resolves into the template object that was created.
   */
  static async initWithUrl (component, templateUrl) {
    // initialise the tempalte using the given URL
    ...
    if (template.stylesheet) {
      component.shadowRoot.appendChild(template.stylesheet)
    }
